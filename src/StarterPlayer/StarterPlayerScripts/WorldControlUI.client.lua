...
local beaconName=Instance.new("TextBox");beaconName.PlaceholderText="Name this return point";beaconName.Text="";beaconName.ClearTextOnFocus=false;beaconName.TextSize=17;beaconName.Size=UDim2.new(1,-28,0,40);beaconName.Position=UDim2.fromOffset(14,44);beaconName.Parent=beacon;Theme.Panel(beaconName,false);beaconName.TextColor3=C.Text;Theme.Corner(beaconName,6)
