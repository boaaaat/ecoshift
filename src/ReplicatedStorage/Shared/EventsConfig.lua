...
EventsConfig.Definitions = {
	...
	SolarFlare = {
		...
		Effects = {},
		Modifiers = { Temp = 2 },
		Drops = { { ItemId = "Glass", Count = 1, Chance = 0.2 } },
		DropInterval = 15,
	...
	BuriedTreasure = {
		...
		Drops = {
			...
			{ ItemId = "Bone", Count = { min = 1, max = 2 }, Chance = 0.3 },
			{ ItemId = "Sandite", Count = 1, Chance = 0.15 },
		},
		DropInterval = 10,
	...
	ScorpionSwarm = {
		...
		Modifiers = {},
		Drops = {
			{ ItemId = "CactusSpine", Count = { min = 1, max = 3 }, Chance = 0.35 },
			{ ItemId = "Bone", Count = 1, Chance = 0.2 },
		},
		DropInterval = 8,
	...
	OasisMirage = {
		...
		Modifiers = { Temp = -1 },
		Drops = {
			{ ItemId = "CactusFlesh", Count = { min = 1, max = 2 }, Chance = 0.45 },
			{ ItemId = "CactusJuice", Count = 1, Chance = 0.25 },
		},
		DropInterval = 10,
	...
	SulfurVent = {
		...
		Drops = {
			{ ItemId = "Sulfite", Count = { min = 1, max = 3 }, Chance = 0.5 },
	...
	DustDevil = {
		...
		Drops = {
			...
			{ ItemId = "Bone", Count = 1, Chance = 0.15 },
		},
		DropInterval = 6,
	...
	SandWurmRise = {
		...
		Modifiers = { Temp = 1 },
		Drops = {
			{ ItemId = "Bone", Count = { min = 2, max = 4 }, Chance = 0.4 },
			{ ItemId = "Sandite", Count = { min = 1, max = 2 }, Chance = 0.3 },
			{ ItemId = "Sulfite", Count = { min = 1, max = 2 }, Chance = 0.2 },
		},
		DropInterval = 12,
	...
	LavaFlow = {
		...
		Effects = {},
		Modifiers = { Temp = 2 },
		Drops = { { ItemId = "Obsidite", Count = 1, Chance = 0.25 } },
		DropInterval = 10,
	...
	Volcanic = {
		Minor = {
			...
			{ Id = "MeteorShower", Weight = 1.0, Overrides = {
				Effects = { EnemyMultiplier = 0.4 },
				Drops = { { ItemId = "Obsidite", Count = 1, Chance = 0.15 } },
			}},
		},
		Major = {
