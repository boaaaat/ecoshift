...
C.Definitions = {
	Generalist = def(0, "Adaptable survival and emergency recovery.", "compass", {
		...
		{item("Bandage"),item("Water",2)}, {item("Mushroom",4)}, {item("Torch",2)}, {item("SunVest")}, {item("StoneSpear"),item("StaminaRation")},
	}),
	Gatherer = def(400, "Break resources faster and gather loose plants quickly.", "harvest", {
		...
		{item("StoneAxe")},{item("Fiber",4)},{item("Water",2)},{item("Bandage",2)},{item("GardenSickle")},
	}),
	Builder = def(500, "Efficient construction with deployable field defenses.", "build", {
		...
		{item("Wood",12),item("Stone",8)},{item("Plank",6)},{item("Chest")},{item("Workbench")},{item("SteelPickaxe")},
	}),
	Hunter = def(500, "Monster damage and focused team hunting.", "target", {
		...
		{item("StoneSpear")},{item("Mushroom",4)},{item("Bandage",2)},{item("SunVest")},{item("SteelSword",1,"StoneSpear")},
	}),
	Medic = def(600, "Medical healing and faster kit-assisted rescue.", "health", {
		...
		{item("Bandage",2)},{item("RevivalKit")},{item("Bandage",2)},{item("RevivalKit")},{item("Antidote"),item("StaminaRation")},
	}),
	Engineer = def(800, "Faster fabrication and shared station overclocking.", "craft", {
		...
		{item("Wood",8),item("Stone",6)},{item("Plank",4),item("Resin",2)},{item("Workbench")},{item("Furnace")},{item("SteelPickaxe")},
	}),
	Scout = def(400, "Fast, economical travel and shared discoveries.", "map", {
		...
		{item("Torch",2),item("Water",2)},{item("StoneSpear")},{item("Water",2),item("Mushroom",4)},{item("SunVest")},{item("StaminaRation",2)},
	}),
	Cook = def(400, "Efficient food use and restorative crew meals.", "food", {
		...
		{item("Mushroom",6),item("Water",2)},{item("Campfire")},{item("Mushroom",6)},{item("Stove")},{item("StaminaRation",2)},
	}),
	Botanist = def(600, "Plant harvests and controlled regrowth.", "leaf", {
		...
		{item("Fiber",6),item("HealingHerb",4)},{item("Bandage")},{item("Water",3)},{item("HerbalPaste",2)},{item("GardenSickle"),item("Antidote")},
	}),
	Prospector = def(600, "Stronger mineral mining and extra primary mineral finds.", "pickaxe", {
		...
		{item("StonePickaxe"),item("Stone",8)},{item("Torch",2)},{item("Bandage",2)},{item("Water",3)},{item("SteelPickaxe",1,"StonePickaxe")},
	}),
	Warden = def(600, "More health, monster protection and threat control.", "armor", {
		...
		{item("StoneSpear"),item("Bandage")},{item("Mushroom",4)},{item("Bandage")},{item("SunVest")},{item("SteelSword",1,"StoneSpear"),item("DesertCoat",1,"SunVest")},
	}),
	Climatologist = def(800, "Resist and recover from heat and cold exposure.", "temperature", {
		...
		{item("Water",4)},{item("SunVest")},{item("Torch",2)},{item("Water",4)},{item("DesertCoat",1,"SunVest"),item("StaminaRation")},
	}),
}
...
function C.ResourceKind(id)
 local def=require(script.Parent.OverhaulCatalog).Resources[id]
 return def and def.Kind or "Other"
end
return C
